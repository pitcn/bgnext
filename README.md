...
为金团记账、拍卖和结算准备的社区插件。团长管理起拍价与账单，团员整理心愿和个人心理价，自己的角色进度集中查看。BGNext 基于官方 **BGLite 纯净版 2.4.1** 独立维护，重视日常操作效率、性能和本地隐私。
...
- 上游基线：官方 BGLite 纯净版 2.4.1
- 基线提交：`31b4942e3251d8bba5c6e6be56fc427da2ae045f`
- 原版文件：188 个
- 基线完整性：由 [SHA-256 清单](docs/baseline/BGLite-2.4.1.sha256)、[明确覆盖清单](docs/baseline/BGNext-overrides.sha256)和自动检查共同保护
- 当前版本：0.6.0；各客户端实机验证状态以测试文档和发布说明为准
...
仓库记录了官方 BGLite 纯净版 2.4.1 分发快照的全部 188 个文件。来源哈希只证明文件身份，不代表所有上游行为已经通过 BGNext 安全审计；BGNext 对必要修改逐文件登记、测试和复核。详见[基线说明](docs/baseline/README.md)。
