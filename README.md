...
- 当前版本：0.5.0；各客户端实机验证状态以测试文档和发布说明为准
...
- 团队账单：保留原版 BGLite 的高密度金团表格，支持拍卖、记账、交易与邮件核对。
- 价格预设：团长按团本保存多套起拍价方案，团员保存个人心理价。价格输入框点空白也能保存；团长在表格装备上 Alt+右键按预设开拍，Ctrl+右键修改单件价。旧价格字符串可预览导入。
...
- 角色总览与装备过滤：只记录自己登录过的角色；按变化范围刷新，减少不必要的重复工作。
