return function(test)
    ...
    test.eq(identity.version, "0.6.0", "BGNext release version")
    test.eq(identity.upstreamName, "BGLite", "upstream name")
    test.eq(identity.upstreamVersion, "2.4.1", "upstream version")
    ...
    tocFile:close()
    test.eq(toc:find("## X-BGNext-Version: 0.6.0", 1, true) ~= nil, true, "BGNext metadata version")
    test.eq(toc:find("## Version: 2.4.1", 1, true) ~= nil, true, "official upstream package version retained")
