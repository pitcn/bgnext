...
Assert-True ($baselineVerifier.Contains('BGLite-2.4.2.sha256')) 'baseline verifier uses official BGLite 2.4.2 manifest'
Assert-True ($baselineVerifier.Contains('5649f58ac2d7d57d3906c97f0aa679bbe5b3da44')) 'baseline verifier pins official BGLite 2.4.2 commit'
Assert-True (Test-Path -LiteralPath (Join-Path $repo 'docs\baseline\BGLite-2.4.2-exclusions.txt')) 'baseline exclusions are explicit'
