return function(test)
    ...
    test.eq(store.setPersonalPrice(root, "titan", 123, "Leader", "ULD", 1001, 900), true, "set personal price")
    test.eq(store.getPersonalPrice(root, "titan", 123, "Leader", "ULD", 1001), 900, "get personal price")
    test.eq(store.getPersonalPrice(root, "titan", 123, "Alt", "ULD", 1001), nil, "alt isolated")
    test.eq(store.getPersonalPrice(root, "wrath", 123, "Leader", "ULD", 1001), nil, "family isolated")
    test.eq(store.getPersonalPrice(root, "titan", 456, "Leader", "ULD", 1001), nil, "realm isolated")
    test.eq(store.clearPersonalPrice(root, "titan", 123, "Leader", "ULD", 1001), true, "clear personal price")
    test.eq(store.getPersonalPrice(root, "titan", 123, "Leader", "ULD", 1001), nil, "cleared personal price")

    -- Explicit zero is distinct from unset.
    test.eq(store.setPersonalPrice(root, "titan", 123, "Leader", "ULD", 1002, 0), true, "set zero personal price")
    test.eq(store.getPersonalPrice(root, "titan", 123, "Leader", "ULD", 1002), 0, "zero personal price read back")
    test.eq(store.getPersonalPrice(root, "titan", 123, "Leader", "ULD", 9999), nil, "unset personal price is nil")

    -- countPersonalPrices and clearPersonalRaid.
    test.eq(store.setPersonalPrice(root, "titan", 123, "Leader", "ULD", 1003, 10), true, "set second price")
    test.eq(store.countPersonalPrices(root, "titan", 123, "Leader", "ULD"), 2, "count personal prices")
    test.eq(store.clearPersonalRaid(root, "titan", 123, "Leader", "ULD"), true, "clear personal raid")
    test.eq(store.countPersonalPrices(root, "titan", 123, "Leader", "ULD"), 0, "raid cleared")
    ...
    test.eq(store.setPersonalPrice(root, "titan", "123", "Leader", "ULD", 1001, 5), false, "string realm refused")
    test.eq(store.setPersonalPrice(root, "titan", 123, "Leader", "ULD", 0, 5), false, "zero item refused")
    test.eq(store.setPersonalPrice(root, "titan", 123, "Leader", "ULD", 1001, -1), false, "negative price refused")
    ...
    test.eq(store.setPersonalPrice(root, "titan", 123, "Leader", "Naxx", 1, 1), true, "seed personal ceiling")
    for i = 2, store.MAX_ITEMS do
        store.setPersonalPrice(root, "titan", 123, "Leader", "Naxx", i, i)
    end
    test.eq(store.setPersonalPrice(root, "titan", 123, "Leader", "Naxx", 999999, 1), false, "501st personal item refused")
    test.eq(store.setPersonalPrice(root, "titan", 123, "Leader", "Naxx", 1, 77), true, "overwrite personal item allowed")
end
