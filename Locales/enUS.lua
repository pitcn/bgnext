...
do -- BGNext release text
    ...
    L["新增游戏内说明书，集中介绍主要功能、快捷键、命令、权限限制和隐私边界。"] = "Added an in-game guide covering major features, shortcuts, commands, permission limits, and privacy boundaries."
    L["重做待拍队列的布局、关闭与清空交互，窗口尺寸变化时会自动重排。"] = "Redesigned the auction queue layout, close and clear actions, with automatic reflow when the window changes size."
