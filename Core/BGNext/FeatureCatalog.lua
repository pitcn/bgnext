...
local entries = {
    ...
    { id = "auction_center", group = "auction", policy = "optional", basic = false, defaultEnabled = false,
        nameKey = "多拍品中心", summaryKey = "集中查看当前拍品，并对明显异常的手动出价再次确认。",
        clients = clients(), commands = {}, interactions = {} },
    ...
    { id = "settlement_tools", group = "settlement", policy = "optional", basic = false,
        ...
        clients = clients(), commands = {}, interactions = {} },
    { id = "expense_templates", group = "settlement", policy = "optional", basic = false, defaultEnabled = false,
        nameKey = "支出模板", summaryKey = "保存常用补贴和支出项目，预览后只填入空行。",
        clients = clients(), commands = {}, interactions = {} },
    { id = "settlement_summary", group = "settlement", policy = "optional", basic = false, defaultEnabled = false,
        nameKey = "实收与分金预览", summaryKey = "分开显示账面收入、已证实实收、欠款和可分工资。",
        clients = clients(), commands = {}, interactions = {} },
    { id = "trade_announcement", group = "settlement", policy = "required", basic = true,
        nameKey = "交易通报设置", summaryKey = "通报能力始终可用；只有在交易设置中主动开启后才发送。",
        clients = clients(), commands = {}, interactions = {} },
    ...
    { id = "appearance", group = "interface", policy = "optional", basic = false,
        ...
        clients = clients(), commands = {}, interactions = {} },
    { id = "local_history", group = "interface", policy = "optional", basic = false, defaultEnabled = false,
        nameKey = "本地成交摘要", summaryKey = "主动保存最小成交摘要，按保留期查看自己的成交与消费。",
        clients = clients(), commands = {}, interactions = {} },
}
