...
local info = {
    ...
    history = {
        { version = "0.8.9", changelog = { L["修复泰坦重铸 P5 双本分段清理后共享杂项和旧金额残留的问题；新增“清理所有 P5 副本”，并修复清表金币基准未更新。"] } },
        { version = "0.8.8", changelog = { L["修复部分发布包在网易 DD 等工具中可能被识别为目录层级异常的问题；插件功能与 0.8.7 相同。"] } },
        ...
        { version = "0.8.6", changelog = { L["角色总览设置新增上移、下移排序；各客户端版本分别保存，恢复默认排序不会删除角色数据；无效、过期或重复的排序数据会安全忽略。"] } },
        ...
        { version = "0.8.1", changelog = { L["修复键盘焦点、角色总览误报和拍卖折叠，并改进团长工具布局及核心结算流程。"] } },
        { version = "0.8.0", changelog = { L["修复拍卖成功后账表不回填，新增团长工具、多拍品中心、本地成交摘要，并改进自动清表与交易候选清理。"] } },
