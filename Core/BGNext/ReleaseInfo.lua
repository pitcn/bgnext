...
local info = {
    ...
    changelog = {
        L["修复部分 BGNext 窗口关闭后仍占用键盘输入，导致移动或聊天按键暂时失效的问题。"],
        L["修复角色总览把未学习专业的配方错误显示为已就绪；旧角色数据会在该角色再次登录后刷新。"],
        L["拍卖卡片折叠后保持折叠，结束时仍在摘要中显示买家和成交金额。"],
        L["调整团长工具在不同界面缩放下的布局，减少按钮重叠、内容越界和关闭按钮不可见。"],
        L["加固跨服拍卖权限、交易与批量邮件核对，以及相同物品和延迟事件下的结算处理。"],
    },
    history = {
