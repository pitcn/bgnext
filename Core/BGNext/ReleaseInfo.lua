...
local info = {
    ...
    changelog = {
        L["修复拍卖窗口拖动或关闭时的报错，并释放隐藏输入框焦点，避免键盘输入被占用。"],
        L["拍卖成交会先保存买家、金额和账务，再刷新界面；物品缓存或其他界面插件异常不会阻断记账。"],
        L["修复交易对象短暂不可读时买家为空、金额或装备遗漏，以及错误沿用上一位交易对象的问题。"],
        L["修复角色总览专业冷却时间错误，并且只显示当前角色真正学会的配方。"],
        L["修复团长在聊天框 Alt+左键点击装备时误加入心愿；现在会打开拍卖窗口。"],
    },
    history = {
