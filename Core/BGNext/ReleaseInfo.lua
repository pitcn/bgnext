...
local info = {
    ...
    changelog = {
        L["修复成交已写入买家和金额后，交易完成仍可能漏记欠款或算错总消费的问题。"],
        L["恢复表格装备组合快捷键的原版优先级，新增操作不再拦截 Shift 插入链接或交换单元格。"],
        L["拍卖装备过滤恢复同步判断，避免筛选启用后仍显示全部装备。"],
        L["团队刚建立或拾取职责变化时使用实时职责校验，避免第一条合法拍卖控制消息被忽略。"],
        L["对账期间普通成员变化不再清空；离团、来源离队或直接换团时仍会安全停止。"],
    },
    history = {
