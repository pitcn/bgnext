    ...
    titan = {
        ...
        resourceColumns = {
            ...
            resource("alchemyResearch", "炼金研究", "cooldown", "normal", false,
                { kind = "profession-cooldown", key = "alchemyResearch", spellId = 60893, professionSkillLineId = 171 }, false, "FFFFFF"),
            resource("alchemyTransmute", "炼金转化", "cooldown", "normal", false,
                { kind = "profession-cooldown", key = "alchemyTransmute", spellId = 66660, professionSkillLineId = 171 }, false, "FFFFFF"),
            resource("inscriptionResearch", "铭文研究", "cooldown", "normal", false,
                { kind = "profession-cooldown", key = "inscriptionResearch", spellId = 61177, professionSkillLineId = 773 }, false, "FFFFFF"),
            resource("minorInscription", "次级铭文", "cooldown", "normal", false,
                { kind = "profession-cooldown", key = "minorInscription", spellId = 61288, professionSkillLineId = 773 }, false, "FFFFFF"),
            resource("icyPrism", "寒冰棱镜", "cooldown", "normal", false,
                { kind = "profession-cooldown", key = "icyPrism", spellId = 62242, professionSkillLineId = 755 }, false, "FFFFFF"),
            resource("smeltTitansteel", "泰坦精钢", "cooldown", "normal", false,
                { kind = "profession-cooldown", key = "smeltTitansteel", spellId = 55208, professionSkillLineId = 186 }, false, "FFFFFF"),
            resource("spellweave", "法术纹布", "cooldown", "normal", false,
                { kind = "profession-cooldown", key = "spellweave", spellId = 56003, professionSkillLineId = 197 }, false, "FFFFFF"),
            resource("ebonweave", "乌纹布", "cooldown", "normal", false,
                { kind = "profession-cooldown", key = "ebonweave", spellId = 56002, professionSkillLineId = 197 }, false, "FFFFFF"),
            resource("moonshroud", "月影布", "cooldown", "normal", false,
                { kind = "profession-cooldown", key = "moonshroud", spellId = 56001, professionSkillLineId = 197 }, false, "FFFFFF"),
            resource("glacialBag", "冰川包", "cooldown", "normal", false,
                { kind = "profession-cooldown", key = "glacialBag", spellId = 56005, professionSkillLineId = 197 }, false, "FFFFFF"),
    ...
    mop = {
        ...
        resourceColumns = {
            ...
            resource("transmuteLivingSteel", "活化钢", "cooldown", "normal", false,
                { kind = "profession-cooldown", key = "transmuteLivingSteel", spellId = 114780, professionSkillLineId = 171 }, false, "FFFFFF"),
            resource("lightningSteelIngot", "闪电钢锭", "cooldown", "normal", false,
                { kind = "profession-cooldown", key = "lightningSteelIngot", spellId = 138646, professionSkillLineId = 164 }, false, "FFFFFF"),
            resource("shaCrystal", "煞水晶", "cooldown", "normal", false,
                { kind = "profession-cooldown", key = "shaCrystal", spellId = 116499, professionSkillLineId = 333 }, false, "FFFFFF"),
            resource("scrollOfWisdom", "智慧卷轴", "cooldown", "normal", false,
                { kind = "profession-cooldown", key = "scrollOfWisdom", spellId = 112996, professionSkillLineId = 773 }, false, "FFFFFF"),
            resource("facetsOfResearch", "研究刻面", "cooldown", "normal", false,
                { kind = "profession-cooldown", key = "facetsOfResearch", spellId = 131686, professionSkillLineId = 755 }, false, "FFFFFF"),
            resource("serpentsHeart", "蛇心", "cooldown", "normal", false,
                { kind = "profession-cooldown", key = "serpentsHeart", spellId = 140050, professionSkillLineId = 755 }, false, "FFFFFF"),
            resource("magnificenceOfLeather", "壮丽皮革", "cooldown", "normal", false,
                { kind = "profession-cooldown", key = "magnificenceOfLeather", spellId = 140040, professionSkillLineId = 165 }, false, "FFFFFF"),
            resource("imperialSilk", "帝国丝绸", "cooldown", "normal", false,
                { kind = "profession-cooldown", key = "imperialSilk", spellId = 125557, professionSkillLineId = 197 }, false, "FFFFFF"),
            resource("jardsPeculiarEnergy", "贾德能量", "cooldown", "normal", false,
                { kind = "profession-cooldown", key = "jardsPeculiarEnergy", spellId = 139176, professionSkillLineId = 202 }, false, "FFFFFF"),
            resource("money", "金币", "money", "normal", true, { kind = "money" }, true, "FFD700"),
            resource("equipmentDetails", "装备详情", "items", "dynamic-items", false,
                { kind = "equipment" }, false),
        },
