...
BGNext is an independent community enhancement built on the verified official BGLite 2.4.2 Pure Edition supplied for the enhancement activity. It is not an official BiaoGe, BGLite, Blizzard, NetEase, or NetEase DD project.

## Domain terms

- **BGLite baseline** — the immutable 186-file official Pure Edition snapshot identified by commit `5649f58` and `docs/baseline/BGLite-2.4.2.sha256`.
